...
RANDOM_USER_API_URL = "https://randomuser.me/api/0.8/?nat=ca"
...
if __name__ == "__main__":
    ...
    while i != 100:
        try:
            ...
            country_client = CountriesApi()
            country_obj = country_client.iso_code(country_code_alpha2)
            print(country_obj)
            ...
            event_city_name = response_data.json()['results'][0]['user']['location']['state']
            event_message = {}
